...
const ContactSlipMobile = ({id, name, profilePicture, isSelected, isOnline}) => {
  ...
  return (
    <button onClick={handleSelectedContact} data-name={id} className={`min-w-[65px] max-w-[65px] flex flex-col items-center cursor-pointer gap-0.5 py-0.5 rounded-lg ${isSelected ? "bg-base-100 text-base-content" : ""}`}>
