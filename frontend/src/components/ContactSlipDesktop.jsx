...
const ContactSlipDesktop = ({id, name, profilePicture, isSelected, isOnline}) => {
  ...
  return (
    <button onClick={handleSelectedContact} data-name={id} className={`flex items-center gap-2 relative cursor-pointer rounded-lg py-0.5 pl-0.5 mr-2 ${isSelected ? "bg-base-300/80 text-base-content" : ""} `}>
